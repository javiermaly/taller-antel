...
public class WsServiceLocator extends org.apache.axis.client.Service implements com.imm.WsService {
    ...
    public com.imm.Ws getWsPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.imm.Ws getWsPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.imm.WsBindingStub _stub = new com.imm.WsBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.imm.Ws.class.isAssignableFrom(serviceEndpointInterface)) {
                com.imm.WsBindingStub _stub = new com.imm.WsBindingStub(new java.net.URL(WsPort_address), this);
                _stub.setPortName(getWsPortWSDDServiceName());
                return _stub;
            }
        }
